...
public class PostApiControllerTest {
    ...
    public void Posts_등록된다() {
        ...
        List<Posts> listAll = postsRepository.findAll();
        assertThat(listAll.stream().findFirst().get().getTitle()).isEqualTo(title);
        assertThat(listAll.stream().findFirst().get().getContent()).isEqualTo(content);
    }
    ...
    public void Posts_수정된다() {
        ...
        assertThat(all.stream().findFirst().get().getTitle()).isEqualTo(expectedTitle);
        assertThat(all.stream().findFirst().get().getContent()).isEqualTo(expectedContent);
    }
}
